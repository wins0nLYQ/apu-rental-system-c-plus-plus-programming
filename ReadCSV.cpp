...
std::vector<std::string> ReadCSV::splitString(const std::string& input, char delimiter) {
...
vector<Property> ReadCSV::readCSV(const string& filename) {
...
void ReadCSV::printProperties(const vector<Property>& properties) {
    int count = 0;
